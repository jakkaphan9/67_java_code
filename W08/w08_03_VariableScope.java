...
public class w08_03_VariableScope {
    ...
    // Instance Variables (คล้ายตัวแปรระดับคลาส แต่ต้องสร้าง instance ของคลาสเพื่อเข้าถึง)
    int a = 100;
    int b = 200;
...
// สรุป
// ตัวแปร Instance Variable และ Static Variable เป็นตัวแปรที่ถูกประกาศใช้ในระดับคลาส
// ตัวแปร Local Variable เป็นตัวแปรที่ถูกประกาศภายในบล็อกของโค้ด เช่น ภายในฟังก์ชัน เมธอด หรือบล็อกของเงื่อนไข
// ตัวแปร Local Variable จะมีวงจรชีวิตเฉพาะในบล็อกที่ถูกประกาศเท่านั้น
// ตัวแปร Instance Variable และ Static Variable จะมีวงจรชีวิตตามวงจรชีวิตของ object หรือคลาสตามลำดับ
